    ...
    <div className="home">
              ...
              <div className="hero-ip-content">
                <div
                  ...
                  title={serverStatus.online
                    ? `Server Online - ${serverStatus.players?.online || 0}/${serverStatus.players?.max || 0} players`
                    : 'Server Offline'
                  }
                ></div>
      ...
      <section className="features-section section" aria-label="Features">
        <div className="container">
          <h2 className="section-title fade-in">Why Choose Mazecraft?</h2>
      ...
      <section id="about" className="about-section section" aria-label="About Us">
        <div className="container">
          <h2 className="section-title fade-in">About Mazecraft</h2>
      ...
      <section className="news-section section" aria-label="Mazecraft News">
        <div className="container">
          <h2 className="section-title fade-in">Mazecraft News</h2>
          ...
          <div className="news-container fade-in">
            <div className="news-content">
              ...
              <h3>Coming Soon</h3>
              <p>Stay tuned for the latest updates and announcements!</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="community" className="community-section section" aria-label="Community">
        <div className="container">
          <h2 className="section-title fade-in">Join Our Community</h2>

          <div className="community-container">
            <div className="community-widget fade-in">
              <iframe
