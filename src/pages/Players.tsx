    ...
    <div className="page-container">
      <div className="container">
        <div className="map-simple-layout">
          ...
          <h1 className="map-coming-soon">Player Profiles Coming Soon</h1>
          <p className="coming-soon-desc">Advanced player statistics and profiles system in development</p>
